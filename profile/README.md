...
- **Goal:** Based on **open-source custom chips** to build **open-source machine systems** for the future era, just like what Game Science has done in the gaming field, helping people solve some of the challenges encountered in real life
